...
from arctic._util import indent
from arctic.auth import authenticate, get_auth
...
from arctic.backends.backends import APPLICATION_NAME, LIBRARY_TYPES
...
class MongoBackend(object):
    ...
    def __setstate__(self, state):
        return MongoBackend.__init__(self, **state)
    
    @mongo_retry
    def initialize_library(self, library, lib_type, **kwargs):
        """
...
class ArcticLibraryBinding(object):
    ...
    """
    DB_PREFIX = MongoBackend.DB_PREFIX
    TYPE_FIELD = "TYPE"
    QUOTA = 'QUOTA'
