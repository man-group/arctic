...
def test_should_write_top_level_with_correct_timezone(arctic):
    ...
    utc = mktz('UTC')
    arctic.initialize_library('FEED_2010.LEVEL2', tickstore.TICK_STORE_TYPE)
    arctic.initialize_library('FEED_2011.LEVEL2', tickstore.TICK_STORE_TYPE)
    arctic.initialize_library('FEED.LEVEL2', toplevel.TICK_STORE_TYPE)
    toplevel_tickstore = arctic['FEED.LEVEL2']
